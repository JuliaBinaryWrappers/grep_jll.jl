...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import grep_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("47013893-54eb-5c9c-83b4-9a24496ece36"))
platforms = [Pkg.Artifacts.unpack_platform(e, "grep", artifacts_toml) for e in artifacts["grep"]]
...
if best_platform === nothing
    @debug("Unable to load grep; unsupported platform $(triplet(platform_key_abi()))")
else
